...
- [x] PV4: ObstacleField cost model + in-world obstacle rings (PathVisualizer). Reachability grid = WorkspaceMap (existing).
...
- [x] DF4: inference server + Unity client (receding horizon). Robustness benchmark TODO.
