...
namespace ArmSmith
{
    ...
    public class BuilderPanel : MonoBehaviour
    {
        ...
        public void Build(Transform canvas, ProceduralArm a, SensorHub h, EvolutionTrainer t)
        {
            ...
            rt.sizeDelta = new Vector2(250, 380);

            stats = MakeText(root.transform, 14, new Vector2(0, 1), new Vector2(8, -8), new Vector2(234, 70));
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                brt.anchoredPosition = new Vector2(8, -84 - i * 25);
            ...
            // training view at the bottom
            training = MakeText(root.transform, 13, new Vector2(0, 0), new Vector2(8, 8), new Vector2(234, 150));
            training.alignment = TextAnchor.LowerLeft;
        }
