...
from .numeric import judge_localization_success, numeric_success
...
def run_evaluation(
    ...
    for model_response in tqdm(model_response_list):
        ...
        for qa_type, gt_value in gt_value_dict.items():
            ...
            details = numeric_success(gt_value, pred_value, tolerance)
...
def _calculate_localization_success(
    ...
    for group_key, group_data in grouped_data.items():
        ...
        # logger.debug(distance_result)
        # logger.debug(direction_result)
...
def calculate_success_rate(
    ...
    for raw_results in tqdm(raw_results_list):
