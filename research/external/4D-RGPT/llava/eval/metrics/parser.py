"""
TODO
https://github.com/turingmotors/STRIDE-QA-Dataset/blob/main/benchmarks/STRIDE-QA-Bench/src/strideqa_bench/utils/parser.py#L9
"""
...
class Parser:
    ...
    @staticmethod
    def parse_direction(text: str) -> tuple[float | None, str]:
        """
...
def parse_pred_value(qa_type: str, pred_text: str) -> tuple[Any | None, str]:
    match qa_type:
        case "direction":
...
if __name__ == '__main__':
    y = parse_pred_value("velocity", "10 mph")
    print(y)
