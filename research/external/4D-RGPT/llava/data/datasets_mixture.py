...
#
# Synced with the official NVlabs/VILA `llava/data/datasets_mixture.py`.
# The 4D-RGPT training mixture (sat / vstibench / robofac / wolf) is wired
# through the YAML registry at `llava/data/registry/datasets/*.yaml` (cluster-
# specific, gitignored) and `data/registry.yaml`, not via `DATASETS_LEGACY`.
